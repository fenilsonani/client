...
const Footer = () => {
  return (
    ...
    // </footer>
    <>
      <footer class="relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20 sm:hidden">
        <div class="container mx-auto">
          <div class="-mx-4 flex sm:flex-wrap">
            <div class="w-full px-4 sm:w-2/3 lg:w-3/12 sm:flex-wrap">
              <div class="mb-10 w-full">
                ...
                <p class="text-body-color mt-10 mb-7 text-base">
      ...
      <footer class="relative z-10 bg-white lg:hidden sm:ml-4 xl:hidden 2xl:hidden pt-20 pb-10 lg:pt-[120px] lg:pb-20">
        <div class="container mx-auto">
          <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div class="mb-10 w-full">
                ...
                <p class="text-body-color mt-4 mb-7 text-base">
                  Sed ut perspiciatis undmnis is iste natus error sit amet voluptatem
                  totam rem aperiam.
                </p>
                <p class="text-dark flex items-center text-sm font-medium">
