          ...
          <div className="container m-auto space-y-8 px-6 text-gray-600 dark:text-gray-300 md:px-12 lg:px-20">
            <div>
              <div className="mb-6 items-center justify-between gap-6 py-6 sm:flex md:mb-16 md:space-y-6 md:py-0">
                <img width={100} height={42} src="https://iili.io/HCeofoJ.png" alt="logo tailus" className="w-1/7 rounded-full" />
                <div className="mt-6 flex flex-col-reverse flex-wrap gap-6 sm:mt-0 sm:flex-row sm:items-center">
                  ...
                  <div className="flex gap-6">
                    <Link href="#" target="blank" aria-label="github" className="hover:text-primary">
                    ...
                    <Link href="#" target="blank" aria-label="twitter" className="hover:text-primary">
                      <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} fill="currentColor" className="bi bi-twitter" viewBox="0 0 16 16">
                        <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z" />
                      </svg>
                    </Link>
                    <Link href="#" target="blank" aria-label="medium" className="hover:text-primary">
                ...
                <div className="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:grid-cols-5">
                  <div>
                    ...
                    <ul className="mt-4 list-inside space-y-4">
                      <li>
                        <Link href="#" className="transition hover:text-primary">About</Link>
                      </li>
                      <li>
                        <Link href="#" className="transition hover:text-primary">Customers</Link>
                      </li>
                      <li>
                        <Link href="#" className="transition hover:text-primary">Enterprise</Link>
                      </li>
                      <li>
                        <Link href="#" className="transition hover:text-primary">Partners</Link>
                      </li>
                      <li>
                        <Link href="#" className="transition hover:text-primary">Jobs</Link>
                      </li>
                    </ul>
                  </div>
                  <div>
                  ...
                  <div className="col-span-2 sm:col-span-3 md:col-span-2">
                    ...
                    <ul className="mt-4 list-inside space-y-4">
                      <li>
                        <Link href="tel:+243996660436" className="transition hover:text-primary">+243 996 660 436</Link>
                      </li>
                      <li>
                        <Link href="mailto:meschacirung@gmail.com" className="transition hover:text-primary">contact@tailus.com</Link>
                      </li>
                      <li>
                        <form action>
                          <label htmlFor="newsletter" className="text-lg text-gray-700 dark:text-gray-200">Subscribe to our newsletter</label>
                          <div className="relative mt-4">
                            <input type="email" name="newsletter" id="newsletter" placeholder="Your email" className="invalid:outline-none placeholder-gray-600 dark:placeholder-white rounded-3xl w-full bg-gray-100 dark:bg-gray-900 px-4 py-3 ring-1 ring-gray-200 dark:ring-gray-700 invalid:ring-red-400" />
