...
const Footer = () => {
  return (
    // <footer className="text-gray-600 bg-gray-100 mt-10 body-font">
    ...
    //         <Link href="https://twitter.com/artlaaza" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@Artlaza</Link>
    //       </p>
    //       <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
    //         <Link href="https://www.facebook.com/sharer/sharer.php?u=www.youtube.com" target="_blank" className="text-gray-500">
    ...
    // </footer>
    <>
      <footer className="relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20 sm:hidden">
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <div className="mb-6 flex items-center">
                  <a
                    href="javascript:void(0)"
                    className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="8"
                      height="16"
                ...
                <p className="text-body-color text-base">&copy; Artlaaza</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="relative z-10 bg-white lg:hidden sm:ml-4 xl:hidden 2xl:hidden pt-20 pb-10 lg:pt-[120px] lg:pb-20">
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-body-color mt-4 mb-7 text-base">
                  Sed ut perspiciatis undmnis is iste natus error sit amet voluptatem
                  totam rem aperiam.
                </p>
                <p className="text-dark flex items-center text-sm font-medium">
